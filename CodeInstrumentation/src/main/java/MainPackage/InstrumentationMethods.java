...
class InstrumentationMethods {
    ...
    static void ifInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
    ...
    static void thenInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
            public void visit(IfStmt n, Void arg) {
                super.visit(n, arg);
    ...
    static void elseInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
            public void visit(IfStmt n, Void arg) {
                super.visit(n, arg);
    ...
    static void switchInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations) {
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    static void whileInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    static void doWhileInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    static void forInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    static void forEachInstrumentation(String className, String methodName, MethodDeclaration method, List<InnerData.Locations> locations){
        method.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    private static void execute(Statement n, String className, String methodName, List<InnerData.Locations> locations){
    ...
    private static void thenElseExecute(Statement n, String className, String methodName, List<InnerData.Locations> locations){
        BlockStmt replacement = new BlockStmt(new NodeList<>(n));
        for (Locations location : locations) {
            List<InstrumentationClass.Metadata> currentMetadata = processMetadata(location.getMessage());
            if (currentMetadata.contains(InstrumentationClass.Metadata.CLASS)) location.setArg(className, InstrumentationClass.Metadata.CLASS.name());
